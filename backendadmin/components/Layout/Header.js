...
class Header extends React.Component {
  ...
  async handleClick(event) {
    ...
    document.cookie = `name=${this.props.cookies.name}; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;`
    document.cookie = `accessToken=${this.props.cookies.accessToken}; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;`
    document.cookie = `session=${this.props.cookies.session}; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;`
    document.cookie = `unknow=${this.props.cookies.unknow}; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/;`
    Router.push('/login')
  }
  render() {
    return (
