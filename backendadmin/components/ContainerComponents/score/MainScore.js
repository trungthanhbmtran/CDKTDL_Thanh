...
import AddScore_Component from "./MainAddScore";
...
export class MainScore extends Component {
  ...
  _on_Click_delete= (ID_SV_MH)=>{
      this.setState({ID_SV_MH})
      console.log(ID_SV_MH)
  }

  _on_Click_Edit = (ID_SV_MH) => {
    this.setState({ID_SV_MH})
  }

  updateData =()=>{
    Router.reload(window.location.pathname);
    console.log('update data ne')
  }
  ...
  renderTableData() {
    return this.state.data.map((scores, index) => {
      ...
      return (
        <tr key={ID_SV_MH}>
          <td>
            <a data-toggle="modal" data-target="#modalEdit" onClick={()=>{this._on_Click_Edit(ID_SV_MH)}}  className="btn btn-primary btn-xs">
              <i className="fa fa-pencil" />
            </a>
            <button onClick={()=>this._on_Click_delete(ID_SV_MH)}  className="btn btn-danger btn-xs">
  ...
  renderModalAdd(){
      return (
        ...
        <div className="modal-dialog">
            ...
            <AddScore_Component  onClickupdate={this.updateData} {...this.props}/>
            </div>
        </div>
        </div>
    </div>
  ...
  renderModalEdit (){
    return (
      <div className="container">
      {/* Modal */}
      <div className="modal fade" id="modalEdit" role="dialog">
      <div className="modal-dialog">
          {/* Modal content*/}
          <div className="modal-content">
            <EditScore onClickupdate={this.updateData} idtable={this.state.ID_SV_MH} {...this.props} /> 
          </div>
      </div>
      </div>
  </div>
