...
export class AddScore_Component extends Component {
  ...
  // alert(Ngaynhap)
   const input ={"ID_SV_MH": this.state.ID_SV_MH,'ID_LoaiDiem' : this.state.ID_Loaidiem,'Sodiem':this.state.Sodiem,'Ghichu':this.state.Ghichu,
  "Ngaynhap":Ngaynhap,"Nguoinhap":this.props.cookies.unknow
  }
                ...
                <div className="card-body row">
                  ...
                  <div className="col-lg-6 p-t-20">
                    <div className="mdl-textfield mdl-js-textfield mdl-textfield--floating-label txt-full-width">
                      <input className="mdl-textfield__input" type="text" maxLength="3" pattern="^\d+(\.\d)\d|10*$" id="Sodiem" value={this.state.Sodiem} onChange={this.handleChange} />
...
export default AddScore_Component;
