...
var AddForm = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_5__["default"])(AddForm, [{
    ...
    value: function RenderListClasses() {
      ...
      console.log("===> " + JSON.stringify(this.props.results_classes[0]));
      console.log("===> " + lodash__WEBPACK_IMPORTED_MODULE_11___default.a.filter(this.props.results_classes, {
        'ID_Donvi': JavaScript.parseInt(this.state.departments)
      }).length);
